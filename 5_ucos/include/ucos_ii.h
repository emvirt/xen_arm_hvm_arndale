...
typedef struct os_tcb {
    ...
    INT32S           OSTCBDly;         /* Nbr ticks to delay task or, timeout waiting for event        */

//jjw
    //INT32S           OSTCBWake;         /* Nbr ticks to delay task or, timeout waiting for event        */
...
OS_EXT  volatile  INT32U  virtual_time;                   /* Current value of system time (in ticks)         */
OS_EXT  volatile  INT32U  Physical_Time;                   /* Current value of system time (in ticks)         */
OS_EXT  volatile  INT32U  last_time;                   /* Current value of system time (in ticks)         */
#endif
