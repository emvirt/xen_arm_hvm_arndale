...
#define OS_APP_HOOKS_EN           1    /* When 1, app-defined hooks are called from the uC/OS-II hooks */
...
#define OS_TIME_TICK_HOOK_EN      1    /*     Include code for OSTimeTickHook()                        */
                                       ...
                                       /* --------------------- TIMER MANAGEMENT --------------------- */
#define OS_TMR_EN                 0 //1    /* Enable (1) or Disable (0) code generation for TIMERS         */
