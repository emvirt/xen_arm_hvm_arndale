...
#define  NET_IP_ERR_RX_FRAG_SIZE_TOT                   20403    /* Invalid frag tot size.                               */
#define  NET_IP_ERR_RX_FRAG_LEN_TOT                    20404    /* Invalid frag tot len.                                */
#define  NET_IP_ERR_RX_FRAG_DISCARD                    20405    /* Invalid frag(s) discarded.                           */
#define  NET_IP_ERR_RX_FRAG_REASM                      20410    /* Frag'd datagram reasm in progress.                   */
#define  NET_IP_ERR_RX_FRAG_COMPLETE                   20411    /* Frag'd datagram reasm'd.                             */
...
#define  NET_IP_ERR_TX_DEST_THIS_HOST                  20502    /* Tx to this  host's addr.                             */
#define  NET_IP_ERR_TX_DEST_LOCAL_HOST                 20503    /* Tx to lcoal host   addr.                             */
#define  NET_IP_ERR_TX_DEST_BROADCAST                  20504    /* Tx to local net broadcast.                           */
#define  NET_IP_ERR_TX_DEST_HOST_THIS_NET              20505    /* Tx to local net host.                                */
