...
#define  NET_DBG_CFG_INFO_EN                    DEF_DISABLED    /* Configure debug information feature (see Note #1) :  */
                                                                /*   DEF_DISABLED  Debug information DISABLED           */
                                                                /*   DEF_ENABLED   Debug information ENABLED            */

#define  NET_DBG_CFG_STATUS_EN                  DEF_DISABLED    /* Configure debug status functions (see Note #2) :     */
...
*/
                                                                ...
                                                                /* ... (see Note #1) :                                  */
// TODO
#define  NET_ERR_CFG_ARG_CHK_EXT_EN             0 // DEF_ENABLED
...
// TODO
#define  NET_CTR_CFG_STAT_EN                   0  // DEF_ENABLED     /* Configure statistics counter feature (see Note #1) : */
                                                                /*   DEF_DISABLED     Stat  counters DISABLED           */
                                                                /*   DEF_ENABLED      Stat  counters ENABLED            */

#define  NET_CTR_CFG_ERR_EN                    0 // DEF_ENABLED     /* Configure error      counter feature (see Note #2) : */
...
*/
                                                                ...
                                                                /* ... (see Note #1) :                                  */
#define  NET_BUF_CFG_NBR_SMALL                            20    /* Configure total number of SMALL BUFFERs.             */
#define  NET_BUF_CFG_NBR_LARGE                            20    /* Configure total number of LARGE BUFFERs.             */
