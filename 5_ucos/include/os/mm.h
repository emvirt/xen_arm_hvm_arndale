...
#define l2_table_offset(_a) \
  ( (((_a) >> L2_PAGETABLE_SHIFT) & (L2_PAGETABLE_ENTRIES - 1)) *2)
#else
#define l2_table_offset(_a) \
  ( (((_a) >> L2_PAGETABLE_SHIFT) & (L2_PAGETABLE_ENTRIES - 1)) + 1)
#endif
...
extern unsigned long min_mfn;
#define mfn_to_pfn(_mfn) (_mfn-min_mfn)
#endif
...
#else
extern unsigned long xen_guest_phys_offset;
#define PHYS_OFFSET		(xen_guest_phys_offset)

#define to_phys(x)                 ((unsigned long)(x)-VIRT_START+PHYS_OFFSET)
#define to_virt(x)                 ((void *)((unsigned long)(x)+VIRT_START-PHYS_OFFSET))
#endif

#define virt_to_pfn(_virt)         (PFN_DOWN(to_phys(_virt)))
//#define mach_to_virt(_mach)        (to_virt(machine_to_phys(_mach)))//YSB
//#define mfn_to_virt(_mfn)          (mach_to_virt(_mfn << PAGE_SHIFT))//YSB
