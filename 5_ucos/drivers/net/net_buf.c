...
static  void  NetBuf_ClrHdr (NET_BUF_HDR  *pbuf_hdr)
{
    ...
    pbuf_hdr->IP_AddrSrc               = (CPU_INT32U)NET_IP_ADDR_NONE;
    pbuf_hdr->IP_AddrDest              = (CPU_INT32U)NET_IP_ADDR_NONE;
    pbuf_hdr->IP_AddrNextRoute         = (CPU_INT32U)NET_IP_ADDR_NONE;
    pbuf_hdr->IP_AddrNextRouteNetOrder = (CPU_INT32U)NET_UTIL_HOST_TO_NET_32(NET_IP_ADDR_NONE);
    pbuf_hdr->IP_OptPtr                = (void     *)0;
