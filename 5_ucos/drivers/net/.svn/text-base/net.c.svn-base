...
/*$PAGE*/
    ...
    printk("NetNIC_Init\n");
    temp = (unsigned int *)0xE0001000;
    printk("read 0xE0001000 : %x\n", *temp); //Miri
    NetNIC_Init(&err);
...
void  Net_InitDflt (void)
{
   ...
   (void)NetIP_CfgAddrThisHost(NET_IP_ADDR_NONE, NET_IP_ADDR_NONE);
   (void)NetIP_CfgAddrDfltGateway(NET_IP_ADDR_NONE);
 ...
 *                          */
    ...
    ip      = NetASCII_Str_to_IP((CPU_CHAR     *)"192.168.0.2", &err);                  /* Configure the IP address                                 */
    msk     = NetASCII_Str_to_IP((CPU_CHAR     *)"255.255.255.0", &err);                /* Configure the netmask                                    */
    gateway = NetASCII_Str_to_IP((CPU_CHAR     *)"192.168.0.1", &err);                /* Configure the default gateway                            */
