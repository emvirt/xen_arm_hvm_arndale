...
void  OSTimeDly (INT16U ticks)
{
	...
	//printk("OSTimeDly ( %d ) OSTCBCur->OSTCBDly %d @  %d \n", ticks, OSTCBCur->OSTCBDly, OSTime);
...
//if (ptcb->OSTCBDly == 0) {                                 /* See if task is delayed               */
	if (ptcb->OSTCBDly <= OSTime) {                                 /* See if task is delayed               */
        OS_EXIT_CRITICAL();
...
//    ptcb->OSTCBDly = 0;                                        /* Clear the time delay                 */
    ptcb->OSTCBDly = OSTime;                                        /* Clear the time delay                 */
...
INT32U  OSTimeGet (void)
{
	...
	//__asm(" mrc p15, 0, %0, c14, c3, 0":"=r"(current_counter):);
	//if(current_counter > old_cval) {
//		OSTime++;
//	}
//	else if(old_cval  - current_counter > 1000000)
//	{
//		OSTime++;
//	}
//		old_cval = current_counter;
