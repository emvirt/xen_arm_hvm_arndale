...
#define SYSTEM_TIME_MONITOR_SIZE 1000
...
INT32U task_time_table[SYSTEM_TIME_MONITOR_SIZE][5];

INT32U task_time_monitor_flag = 0;
INT32U time_table_index = 0;



INT32U t1_miss_count = 0;
INT32U t2_miss_count = 0;
...
void test1()
{
	...
	if((task_time_monitor_flag == 1) && (time_table_index < SYSTEM_TIME_MONITOR_SIZE)){
		...
		task_time_table[time_table_index][1] = task1_start_p_time_l;
		task_time_table[time_table_index][2] = task1_start_v_time_l;
	}else{
		//__asm("BKPT");
	}
	...
	//__asm("MRRC p15, 1, %0, %1, c14":"=r"(task1_end_v_time_l),"=r"(task1_end_v_time_h):);
		...
		__asm("MRRC p15, 1, %0, %1, c14":"=r"(task1_end_v_time_l),"=r"(task1_end_v_time_h):);
                ...
                task_time_table[time_table_index][3] = task1_end_p_time_l;
                //task_time_table[time_table_index][5] = task1_end_p_time_h;
                task_time_table[time_table_index][4] = task1_end_v_time_l;
