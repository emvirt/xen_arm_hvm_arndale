...
#define GUEST_RAM_BASE 0x80000000	//added by Tae
                         ...
                         xen_vaddr_t start, xen_vaddr_t size)
{
    ...
    //printf("==== xc_dom_alloc_segment function was called ====\n");	//added by Tae
    //printf("==== start : %llu  ====\n",start);	//added by Tae
    //printf("==== size : %llu  ====\n",size);	//added by Tae
    //printf("==== page_size : %d  ====\n",page_size);	//added by Tae
    //printf("==== pages : %llu  ====\n",pages);	//added by Tae
    //printf("==== dom->total_pages : %llu  ====\n",dom->total_pages);	//added by Tae
    ...
    //printf("==== seg->vstart : %llu ====\n",seg->vstart);	//added by Tae
    //printf("==== pfn : %llu ====\n",pfn);	//added by Tae
    //printf("==== seg->pfn : %llu ====\n",pfn);	//added by Tae
...
struct xc_dom_arch *xc_dom_find_arch_hooks(xc_interface *xch, char *guest_type)
{
	...
	if ( !strcmp(hooks->guest_type, "xen-3.0-armv7l"))
...
int xc_dom_parse_image(struct xc_dom_image *dom)
{
    int i;
    /*
    uint32_t entry_addr;	//added by Tae
    uint64_t v_start, v_end;	//added by Tae
    uint64_t rambase = GUEST_RAM_BASE;	//added by Tae
    */
    DOMPRINTF_CALLED(dom->xch);
    ...
    /* added by Tae 
      	If a ELF file uses as kernel image, the segments to boot kernel needed statically

	entry_addr : the address domU kernel will be located
	v_start : the calculated start virtual address  
	v_end : the calculated end virtual address
	rambase : default address that domU will be located '0x80000000'
    */
    /*
    ...
    printf("============== xc_dom_parse_image function was called =============\n");	//added by Tae
    printf("============== v_start : %llu  =============\n",v_start);	//added by Tae
    printf("============== v_end : %llu  =============\n", v_end);	//added by Tae
    printf("============== dom->kernel_size : %"PRIu32" =============\n",dom->kernel_size);	//added by Tae
    */

    //if ( dom->kernel_seg.vstart == 0 ){
...
int xc_dom_build_image(struct xc_dom_image *dom)
{
    ...
    printf("=== dom->kernel_seg.vstart : %llu ===\n",dom->kernel_seg.vstart);
    printf("=== dom->kernel_seg.vend : %llu ===\n",dom->kernel_seg.vend);
