                                  ...
                                  struct elf_binary *elf, bool load)
{
    ...
    printf("================ xc_dom_load_elf_symtab function was called !!!  ===================\n");
...
static elf_errorstatus xc_dom_load_elf_kernel(struct xc_dom_image *dom)
{
    ...
    /* ======================================================  */
    /* modified by Taekyoung Kim */
    /* ======================================================  */

    segsize = dom->kernel_seg.vend - dom->kernel_seg.vstart;
    page_size = XC_DOM_PAGE_SIZE(dom);
     
    pages = (segsize + page_size -1) / page_size;
    ...
    printf("========== xc_dom_load_elf_kernel function !!! ===========\n");	//added by Tae
    printf("===== segsize : %llu =====\n",segsize);	//added by Tae
    ...
    printf("==== xc_dom_load_elf_kernel was finished !!! =====\n"); 	//added by Tae
